...
//     Connection String:      `Data Source=DESKTOP-FSCNUBH;Initial Catalog=StarPhoneWebsite;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace ShopConnection
{
    ...
    public partial class LoaiSP : ShopConnectionDB.Record<LoaiSP>  
    {
    ...
    public partial class NSX : ShopConnectionDB.Record<NSX>  
    {
    ...
    public partial class SanPham : ShopConnectionDB.Record<SanPham>  
    {
		...
		[Column] public int? SLDaBan { get; set; }
